    ...
    <CardWrapper>
      <article className="bg-white rounded-xl shadow-md overflow-hidden hover:shadow-xl transition-shadow duration-300 h-full flex flex-col">
        ...
        <div className="p-5 flex flex-col flex-1">
          ...
          {/* Title */}
          <h3 className={`text-base font-bold text-gray-900 mb-2 leading-snug flex-1 ${link ? 'group-hover:text-blue-700 transition-colors' : ''}`}>
            {news.title}
          </h3>
          ...
          <div className="flex items-center justify-between mt-auto pt-3 border-t border-gray-100">
            ...
            {link && (
              <span className="text-xs font-medium text-blue-600 group-hover:text-blue-800 flex items-center gap-1 ml-auto">
